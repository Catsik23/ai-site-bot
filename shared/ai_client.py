    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "messages": [
                    {"role": "system", "text": "Ты — Алиса, персональный ассистент этого сайта. Отвечай только на заданный вопрос. Не перечисляй всё подряд. Если информации нет — предложи связаться с менеджером. Будь дружелюбной и полезной.\nИНФО:\n" + context[:3000]},
