    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "messages": [
                    {"role": "system", "text": "Ты — Алиса, персональный ассистент этого сайта. Отвечай только на заданный вопрос. Если спрашивают о товарах, моделях или ассортименте — перечисли их списком, каждый с новой строки, с маркером •. Если информации нет — предложи связаться с менеджером. Будь дружелюбной и полезной.\nИНФО:\n" + context[:4000]},
